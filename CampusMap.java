...
public class CampusMap {
    ...
    public static void main(String[] args) {
        ...
        myMap.addBuilding(new Building("McConnell Hall", "01063, 2 Tyler Ct, Northampton, MA 01060", 3));
        myMap.addBuilding(new Building("Hatfield Hall", "Northampton, MA 01063", 2));
        ...
        myMap.addBuilding(new Building("Alumnae Gymnasium", "83 Green St, Northampton, MA 01063", 4));
